...
namespace ETCF
{
    public partial class FormDemo : FormEx
    {
        ...
        public void adddataGridViewRoll(string s_Id, string s_JgCarType, string s_RsuCarType, string s_RsuTradeTime, string s_JgTime, string s_RsuPlateNum, string s_CamPlateNum, string s_RsuPlateColor, string s_CamPlateColor, string s_Cambiao, string s_JgId, string s_JgLength, string s_JgWide, string s_CamPicPath)
        {
            try
            {
                this.Invoke(new ThreadStart(delegate
                {
                    ...
                    if (dataGridViewRoll.Rows.Count > 20)
                    {
        ...
        private JGContrlDll jgLaser;
        public void initJGDll()
        {
            if (jgLaser == null)
            {
                jgLaser = new JGContrlDll();
                jgLaser.pLaserCallBack = LaserCallBack;
            ...
            ip[2] = 2;
            ip[3] = 240;
            int res = jgLaser.Initialize(ip, 4007);
        ...
        public int LaserCallBack(int type, IntPtr data, int len)
        {
                            ...
                            { 
                                ...
                                case 2:
                                    ...
                                    string InsertString = @"Insert into " + sql_dbname
                                        ...
                                        +"OBUPlateColor,OBUPlateNum,TradeTime,InputTime,CarFlage) values('"
        ...
        private void imageButtonNext_Click(object sender, EventArgs e)
        {
            ...
            NextCount++;
            adddataGridViewRoll(NextCount.ToString(), DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss:fff"), "2",
